...
export default class FallingStones extends Mastery {
    constructor(){
        ...
        this.description = 'When you start using an ability, there is a chance to drop rocks on enemies.'
    }
    ...
    async trigger(player: Character, ability: Ability){
            ...
            for(let i = 1; i <= count; i++){
                ...
                effect.setPoint(player.x + Math.sin(angle) * distance_x, player.y + Math.cos(angle) * distance_y)
