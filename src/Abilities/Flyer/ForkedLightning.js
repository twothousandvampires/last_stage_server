...
var ForkedLightningProjectile_1 = require("../../Objects/Projectiles/ForkedLightningProjectile");
var FlyerAbility_1 = require("./FlyerAbility");
var ForkedLightning = /** @class */ (function (_super) {
    __extends(ForkedLightning, _super);
    function ForkedLightning(owner) {
        var _this = _super.call(this, owner) || this;
        _this.cost = 4;
        _this.name = 'forked lightning';
        _this.improved_chain_reaction = false;
        _this.lightning_eye = false;
        return _this;
    }
    ForkedLightning.prototype.canUse = function () {
        return this.owner.resource >= this.cost;
    };
    ForkedLightning.prototype.use = function () {
        var _this = this;
    ...
    ForkedLightning.prototype.act = function () {
        if (this.action && !this.hit) {
            ...
            var proj = new ForkedLightningProjectile_1.ForkedLightningProjectile(this.level);
...
exports.default = ForkedLightning;
