...
var FlameRing = /** @class */ (function (_super) {
    __extends(FlameRing, _super);
    function FlameRing() {
    ...
    FlameRing.prototype.canBeForged = function (character) {
        return this.power < 3;
    };
    FlameRing.prototype.forge = function (character) {
        this.power++;
        this.chance += 5;
    };
    FlameRing.prototype.equip = function (character) {
        character.whenHitedTriggers.push(this);
    };
    FlameRing.prototype.trigger = function (character) {
        var _this = this;
