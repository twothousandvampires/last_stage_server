...
var GraceShard = /** @class */ (function (_super) {
    __extends(GraceShard, _super);
    function GraceShard(level) {
        var _this = _super.call(this, level) || this;
        _this.name = 'grace shard';
        _this.box_r = 1;
        _this.time = Date.now();
        return _this;
    }
    GraceShard.prototype.act = function (time) {
        var _this = this;
