...
import FireExplosionMedium from "../Effects/FireExplosionMedium.js";
import FireExplosionSmall from "../Effects/FireExplosionSmall.js";
import { FlameWallObject } from "./FlameWallObject.js";
...
export class FireballProjectile extends Projectiles {
    ...
    act(): void { 
        ...
        for(let i = 0; i < players.length; i++){
            ...
            if(Func.elipseCollision(this.getBoxElipse(), p.getBoxElipse()) && !this.hitted.includes(p.id)){
