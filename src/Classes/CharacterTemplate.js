...
var characterTemplate = /** @class */ (function () {
    ...
    characterTemplate.prototype.setTemplate = function (class_name) {
        if (class_name === void 0) { class_name = 'swordman'; }
    ...
    characterTemplate.prototype.increseStat = function (stat) {
        if (this.stat_count > 0) {
            this.stats[stat]++;
            this.stat_count--;
        }
    };
    characterTemplate.prototype.decreaseStat = function (stat) {
...
exports.default = characterTemplate;
